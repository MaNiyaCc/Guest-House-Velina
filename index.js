const onRoomClick = (roomName) => {
  switch (roomName) {
    case 'floor1': {
      showRoomModal('../images/firstfloor1.png')
      break;
    }
    case 'floor2': {
      showRoomModal('../images/secondfloor1.png')
      break;
    }
    case 'floor3': {
      showRoomModal('../images/3floor.png')
      break;
    }
    case 'kitchen': {
      showRoomModal('../images/thekitchen.png')
      break;
    }
    case 'outdoors': {
      showRoomModal('../images/outside1.png')
      break;
    }
  }
}
